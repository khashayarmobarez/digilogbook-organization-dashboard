...
// queries
import { useAClubCourseClasses } from '@/api/useClub';
...
const TheoryClass = ({params}) => {
    ...
    const {  data: classesData, isLoading: classesDataLoading, error: classesDataError } = useAClubCourseClasses(courseId,clubId);
