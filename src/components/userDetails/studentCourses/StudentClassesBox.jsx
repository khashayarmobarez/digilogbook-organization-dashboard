...
// queries
import { useAStudentCourseClass } from '@/api/courseDetails';


const StudentClassesBox = (props) => {
    ...
    const {  data: classDetails, isLoading: classDetailsLoading, error: classDetailsError } = useAStudentCourseClass(classData.id, userId);
...
export default StudentClassesBox;